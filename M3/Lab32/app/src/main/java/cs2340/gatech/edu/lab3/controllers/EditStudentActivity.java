...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter(this,android.R.layout.simple_spinner_item, Student.legalClassStanding);
    ...
    protected void onAddPressed(View view) {
        ...
        if (((String) classSpinner.getSelectedItem()).equals("FR")) {
            _student.set_standing(ClassStanding.FRESHMAN);
        } else if (((String) classSpinner.getSelectedItem()).equals("SO")) {
            _student.set_standing(ClassStanding.SOPHOMORE);
        } else if (((String) classSpinner.getSelectedItem()).equals("JR")) {
            _student.set_standing(ClassStanding.JUNIOR);
        } else {
            _student.set_standing(ClassStanding.SENIOR);
        }
