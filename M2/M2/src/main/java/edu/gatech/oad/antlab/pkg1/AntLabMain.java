 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Wiqas Nassar");
		  toPrint += p1.toString("wnassar3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Dhurv Garg");
		  toPrint += p2.toString("dgarg8");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Shaurye Aggarwal");
		  toPrint += p3.toString("saggarwal46");
            //Person4 replace P4 with your name
            //and gburdell4 with your gt id
            Person4 p4 = new Person4("Dor Hananel");
            toPrint += p4.toString("dhananel3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Anmol");
                  toPrint += p5.toString("alal30");
                  Person6 p6 = new Person6("Tithi Raval");
                  toPrint += p6.toString("traval6");
