...
public class EditProfileActivity extends AppCompatActivity {
     ...
     */
    public void editProfileSaveRequest(@SuppressWarnings("UnusedParameters") View view) {
     ...
     */
    public void cancelEditProfile(@SuppressWarnings("UnusedParameters") View view) {
        EditProfileActivity.this.finish();
    }
}
