...
public class SourceReport {
    public static final List<String> legalWaterTypes = Arrays.asList("Bottled", "Well", "Stream", "Lake",
            "Spring", "Other");
    public static final List<String> legalWaterConditions = Arrays.asList("Waste", "Treatable-Clear",
