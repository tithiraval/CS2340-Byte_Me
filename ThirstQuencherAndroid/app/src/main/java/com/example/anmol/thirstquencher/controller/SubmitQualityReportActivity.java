...
public class SubmitQualityReportActivity extends AppCompatActivity {
    ...
    public void submitQualityReport(@SuppressWarnings("UnusedParameters") View view) {
    ...
    public void cancelSubmitQualityReport(@SuppressWarnings("UnusedParameters") View view) {
        SubmitQualityReportActivity.this.finish();
    }
}
